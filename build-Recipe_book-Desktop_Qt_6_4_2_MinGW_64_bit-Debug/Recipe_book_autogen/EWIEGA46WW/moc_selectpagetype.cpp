...
#include <memory>
#include "../../../Recipe_book/selectpagetype.h"
...
namespace {
struct qt_meta_stringdata_SelectPageType_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SelectPageType_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SelectPageType_t qt_meta_stringdata_SelectPageType = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SelectPageType[] = {
...
Q_CONSTINIT const QMetaObject SelectPageType::staticMetaObject = { {
    ...
    qt_meta_stringdata_SelectPageType.offsetsAndSizes,
    qt_meta_data_SelectPageType,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SelectPageType_t,
        // Q_OBJECT / Q_GADGET
...
void *SelectPageType::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelectPageType.stringdata0))
